...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public Item getItem(int id){
        ...
        if (cursor != null) {
            ...
            item.setItemQuantity(Integer.parseInt(cursor.getString(cursor.getColumnIndex(Constants.KEY_QTY_NUMBER))));
            ...
            String formattedDate = dateFormat.format(new Date(cursor.getLong(cursor.getColumnIndex(Constants.KEY_DATE_NAME))).getTime());  //Example :- Feb 23, 2020
